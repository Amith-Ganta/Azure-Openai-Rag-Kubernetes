...
# PyMuPDF 1.27.x ships an ONNX-based layout model that is enabled by default and
# crashes on some PDFs (int32/int64 dtype mismatch in BoxRFDGNN). Fall back to the
# stable classic markdown extractor.
try:
